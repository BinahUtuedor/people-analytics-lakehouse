...
operational data storage, data quality, ETL, lakehouse processing,
analytics, metadata, catalogue management, inbound integrations and
outbound data sharing.

See the complete repository structure:
